...
final Widget imageOnlyWidget = Column(
  ...
  crossAxisAlignment: CrossAxisAlignment.start,
  children: [
    if (!shouldWrapImageInBubble) replyPreview(),
    messageBody,
  ],
);

// ✅ TEXT + IMAGE-REPLY: keep inside bubble
...
class _AutoShrinkNamesText extends StatelessWidget {
  final String text;
  final double baseFontSize;
